...
def test_tracing_v1_then_v2_endpoint_published(context, evt_name):
    ...
    assert len(TracingProviderAppDataV1.load(tracing_out.local_app_data).ingesters) == NO_RECEIVERS_LEGACY
...
def test_tracing_v1_and_v2_endpoints_published(context):
    ...
    assert len(TracingProviderAppDataV1.load(tracing_v1_out.local_app_data).ingesters) == NO_RECEIVERS_LEGACY
    assert len(TracingProviderAppDataV2.load(tracing_v2_out.local_app_data).receivers) == NO_RECEIVERS_LEGACY + 1
