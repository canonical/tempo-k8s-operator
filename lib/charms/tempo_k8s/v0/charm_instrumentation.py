...
from typing import Any, Callable, Generator, Optional, Type, TypeVar, Union, cast, Sequence
...
def autoinstrument(
        ...
        tempo_endpoint_getter: Union[
            Callable[[CharmBase], Optional[str]],
            property
        ],
        service_name: Optional[str] = None,
    ...
    :arg service_name: service name traces generated by this charm should be tagged with.
        Defaults to the juju application name this charm is deployed under.
    :arg extra_types: pass any number of types that you also wish to autoinstrument.
